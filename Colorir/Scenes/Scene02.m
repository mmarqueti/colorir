...
@property (nonatomic) SKShapeNode *brush;
@property (nonatomic) SKColor *brush_color;
...
{
    // NSLog(@"Draw to be used: %@", [self.userData objectForKey:@"bg_draw"]);
    
    SKSpriteNode *background_2 = [SKSpriteNode spriteNodeWithImageNamed:[self.userData objectForKey:@"bg_draw"]];
    background_2.anchorPoint = CGPointZero;
    background_2.position = CGPointZero;
    
    [self addChild:background_2];
    
    _brush_color = SKColor.blackColor;
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    for (UITouch *touch in touches)
    {
        ...
        CGRect circle = CGRectMake(loc.x - 10.0, loc.y - 10.0, 20.0, 20.0);
        UIBezierPath *ppath = [UIBezierPath bezierPathWithOvalInRect:circle];
        
        _brush = [[SKShapeNode alloc] init];
        _brush.path = ppath.CGPath;
        _brush.fillColor = _brush_color;
        _brush.strokeColor = nil;
        ...
        else if ([_color_1 containsPoint:location])
        {
            ...
            _brush.fillColor = SKColor.blackColor;
        ...
        else if ([_color_2 containsPoint:location])
        {
            ...
            _brush.fillColor = SKColor.blueColor;
